...
const Contact = () => {
  return (
    ...
    data-aos-anchor-placement="top-center" className="min-h-screen">
      ...
      <section className="mb-32 my-20 lg:my-64 ">
        <div className="flex flex-wrap">
        <div className="mb-10 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6">
    <h2 className="mb-6 text-3xl font-bold">Contact With Prime Places</h2>
    <p className="mb-6 text-neutral-500 dark:text-neutral-300">
    Prime Places, where luxury meets sophistication. Our exclusive collection of premium estates offers unparalleled elegance and opulence. Each property is meticulously designed with the finest craftsmanship and attention to detail, providing an exquisite living experience for the discerning buyer.
    </p>
    <p className="mb-2 flex items-center gap-2 text-neutral-500 dark:text-neutral-300">
    <MdOutlineLocationCity /> New York, 94126, United States
    </p>
    <p className="mb-2 flex items-center gap-2 text-neutral-500 dark:text-neutral-300">
    <FaPhoneVolume />  +01 234 567 89
    </p>
    <p className="mb-2 flex items-center gap-2 text-neutral-500 dark:text-neutral-300">
    <MdEmail />  info@primeplaces.com
    </p>
</div>
